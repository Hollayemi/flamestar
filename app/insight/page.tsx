...
const categories: { title: string; description: string; articles: InsightArticle[] }[] = [
  {
    ...
    articles: [
      { title: "Nigerian Economic Outlook (Quarterly)", href: "/insights/news", ...dateAndReadTime },
      {
        title: "Interest Rate Trends & Fixed Income Opportunities",
        href: "/insights/news",
        ...dateAndReadTime,
      },
      { title: "Inflation Impact on Investment Portfolios", href: "/insights/news", ...dateAndReadTime },
    ],
  },
  {
  ...
  },
  {
    ...
    articles: [
      { title: "How HNWIs Structure Their Wealth", href: "/insights/news", ...dateAndReadTime },
      { title: "Building Generational Wealth in Nigeria", href: "/insights/news", ...dateAndReadTime },
      {
  ...
  },
  {
    ...
    articles: [
      { title: "Quarterly Investment Reports", href: "/insights/reports", ...dateAndReadTime },
      { title: "Portfolio Performance Reviews", href: "/insights/reports", ...dateAndReadTime },
      { title: "Market Intelligence Briefs", href: "/insights/reports", ...dateAndReadTime },
    ],
  },
];
  ...
  return (
    <HomeWrapper>
      <Hero
        ...
        backgroundImage="/images/insights-hero-market-data.jpg"
        size="tall"
      ...
      <FeaturedInsight
        image="/images/insights-featured-financial-review.jpg"
        ...
        cta={{ label: "Read Full Report", href: "/insights/news" }}
      />
